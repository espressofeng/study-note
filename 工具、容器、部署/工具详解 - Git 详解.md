...
- **在线学习**
  - 有个很好的在线学习网站，推荐给大家： [https://learngitbranching.js.org/在新窗口打开](https://learngitbranching.js.org/)![img](/images/tool-git-learn-1.png)
...
![img](./../笔记图片/git-four-areas.png)

代码撤销和撤销同步

![img](./../笔记图片/git-five-states.png)



### 2、Git常用操作命令 - 代码提交和同步代码
