...
![img](../笔记图片/dev-security-injection-xpath-1.png)

### 如何攻击的?

如果用户传入类似 ’ or 1=1 or ”=’ 的值，那么该查询语句也会得到 true 返回值，将返回所有用户的列表。

![img](../笔记图片/dev-security-injection-xpath-2.png)
...
![img](../笔记图片/dev-injection-ldap-1.jpg)

入口点和属性之间的关系为：

![img](../笔记图片/dev-injection-ldap-2.jpg)
