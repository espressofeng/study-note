# 7 - Redis进阶 - 数据结构：redis对象与编码(底层结构)对应关系详解

> 在学习完[底层数据结构]()之后，我们终于可以结合前文内容阐述redis对象及编码之间的关系了。@pdai

- Redis进阶 - 数据结构：redis对象与编码(底层结构)对应关系详解
  - [redis对象与编码(底层结构)对应关系引入](#redis对象与编码底层结构对应关系引入)
  - [字符串对象](#字符串对象)
  - [列表对象](#列表对象)
  - [哈希对象](#哈希对象)
  - [集合对象](#集合对象)
...
## [#](#redis对象与编码-底层结构-对应关系引入) redis对象与编码(底层结构)对应关系引入

在对[对象机制详解]() 和 [底层数据结构]() 有了初步认识之后，我们便可以继续理解它们是怎么对应的：

![img](./../笔记图片/db-redis-object-2-4.png)
...
![img](./../笔记图片/db-redis-x-object-4.png)
...
![img](./../笔记图片/db-redis-x-object-9.png)

当使用 hashtable 编码时，上面命令存储如下：

![img](./../笔记图片/db-redis-x-object-10.png)
...
![img](./../笔记图片/db-redis-x-object-11.png)

```bash
SADD Dfruits "apple" "banana" "cherry"
```

![img](./../笔记图片/db-redis-x-object-12.png)
...
![img](./../笔记图片/db-redis-ds-x-25.png)

然后是编码为SKIPLIST时, 有序集合的内存布局如下:

![img](./../笔记图片/db-redis-ds-x-26.png)
...
![img](./../笔记图片/db-redis-x-object-13.png)

![img](./../笔记图片/db-redis-x-object-14.png)
...
著作权归@pdai所有 原文链接：https://pdai.tech/md/db/nosql-redis/db-redis-data-type-enc.html