...
![img](./../笔记图片/db-redis-object-2-3.png)
...
![img](./../笔记图片/db-redis-ds-x-5.png)

整个ziplist在内存中的存储格式如下：

![img](./../笔记图片/db-redis-ds-x-6.png)
...
![img](./../笔记图片/db-redis-ds-x-9.png)

如果我们增加如下两级索引，那么它搜索次数就变成了3次

![img](./../笔记图片/db-redis-ds-x-10.png)
