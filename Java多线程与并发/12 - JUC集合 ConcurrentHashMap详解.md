...
1、不建议直接去new ConcurrentHashMap()，因为无参构造是
...
创建了空的ConcurrentHashMap，到时扩容的代价很大 且影响性能
...
![img](./../笔记图片/java-thread-x-concurrent-hashmap-1.png)
...
![img](./../笔记图片/java-thread-x-concurrent-hashmap-2.png)
