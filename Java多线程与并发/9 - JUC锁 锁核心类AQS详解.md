...
## （二）AbstractQueuedSynchronizer简介
...
## （三）AbstractQueuedSynchronizer数据结构
...
![image](./../笔记图片/java-thread-x-juc-aqs-1.png)
...
## （四）AbstractQueuedSynchronizer源码分析
...
![image](./../笔记图片/java-thread-x-juc-aqs-2.png)
...
![image](./../笔记图片/java-thread-x-juc-aqs-3.png)
...
## （五）AbstractQueuedSynchronizer示例详解一
...
![image](./../笔记图片/java-thread-x-juc-aqs-4.png)
...
![image](./../笔记图片/java-thread-x-juc-aqs-5.png)
...
![image](./../笔记图片/java-thread-x-juc-aqs-8.png)
...
![image](./../笔记图片/java-thread-x-juc-aqs-9.png)
...
## （六）AbstractQueuedSynchronizer示例详解二
...
![image](./../笔记图片/java-thread-x-juc-aqs-10.png)
...
![image](./../笔记图片/java-thread-x-juc-aqs-16.png)

说明: 其中，head设置为包含c1线程的结点，c1继续运行。

- c1线程执行fullCondtion.signal，其方法调用顺序如下，只给出了主要的方法调用。

![image](./../笔记图片/java-thread-x-juc-aqs-17.png)
...
![image](./../笔记图片/java-thread-x-juc-aqs-18.png)

说明: 最终c2线程会获取锁资源，继续运行用户逻辑。

- c2线程执行emptyCondition.await，由前面的第七步分析，可知最终的状态如下。

![image](./../笔记图片/java-thread-x-juc-aqs-19.png)
...
![image](./../笔记图片/java-thread-x-juc-aqs-20.png)

- p2继续运行，执行emptyCondition.signal，根据第九步分析可知，最终到达的状态如下。

![image](./../笔记图片/java-thread-x-juc-aqs-21.png)
...
![image](./../笔记图片/java-thread-x-juc-aqs-22.png)
...
## （七）AbstractQueuedSynchronizer总结
