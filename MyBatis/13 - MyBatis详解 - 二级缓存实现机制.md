...
- MyBatis详解 - 二级缓存实现机制
  - MyBatis二级缓存实现
    ...
    - [使用二级缓存，必须要具备的条件](#使用二级缓存必须要具备的条件)
...
![img](./../笔记图片/mybatis-y-cache-10.png)
...
![img](./../笔记图片/mybatis-y-cache-11.png)
...
![img](./../笔记图片/mybatis-y-cache-12.png)
...
## [#](#如何细粒度地控制你的mybatis二级缓存) 如何细粒度地控制你的MyBatis二级缓存
...
![img](./../笔记图片/mybatis-y-cache-21.png)
...
著作权归@pdai所有 原文链接：https://pdai.tech/md/framework/orm-mybatis/mybatis-y-cache-level2.html