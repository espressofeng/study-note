...
- MyBatis详解 - 官网配置清单
  ...
  - [事务管理器（transactionManager）](#事务管理器transactionmanager)
  - 数据源（dataSource）
    - [UNPOOLED](#unpooled)
    - [POOLED](#pooled)
    - [JNDI](#jndi)
...
## [#](#类型处理器-typehandlers) 类型处理器（typeHandlers）
...
## [#](#对象工厂-objectfactory) 对象工厂（objectFactory）
