...
- MyBatis详解 - 配置解析过程
  - [回顾上文配置解析方法](#回顾上文配置解析方法)
  - 配置文件元素
    - [元素1：properties](#元素1properties)
    - [元素2：envirements](#元素2envirements)
    - [解析方法：propertiesElement、environmentsElement](#解析方法propertieselementenvironmentselement)
    - [元素3：typeAliases](#元素3typealiases)
    - [解析方法：typeAliasesElement](#解析方法typealiaseselement)
    - [元素4：TypeHandler](#元素4typehandler)
    - [解析方法：typeHandlerElement](#解析方法typehandlerelement)
    - [元素5：objectFactory](#元素5objectfactory)
    - [元素6：plugins](#元素6plugins)
    - [元素7：mappers](#元素7mappers)
    - [解析方法：objectFactoryElement、pluginElement、mapperElement](#解析方法objectfactoryelementpluginelementmapperelement)
    - [元素8：settings](#元素8settings)
    - [解析方法：settingsElement](#解析方法settingselement)
