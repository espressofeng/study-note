...
- MyBatis详解 - 数据源与连接池
  ...
  - 官网DataSource配置内容清单
    ...
    - [POOLED](#pooled)
    - [JNDI](#jndi)
  - [数据源DataSource的创建过程](#数据源datasource的创建过程)
...
![img](./../笔记图片/mybatis-y-datasource-2.png)
...
![img](./../笔记图片/mybatis-y-datasource-3.png)
...
![img](./../笔记图片/mybatis-y-datasource-4.png)
...
![img](./../笔记图片/mybatis-y-datasource-5.png)
...
![img](./../笔记图片/mybatis-y-datasource-6.png)
...
![img](./../笔记图片/mybatis-y-datasource-7.png)
...
著作权归@pdai所有 原文链接：https://pdai.tech/md/framework/orm-mybatis/mybatis-y-datasource.html