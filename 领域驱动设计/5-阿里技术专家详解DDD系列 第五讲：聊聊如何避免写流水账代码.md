# 5-阿里技术专家详解DDD系列 第五讲：聊聊如何避免写流水账代码
...
![img](../笔记图片/v2-dc1178ffbf8bb38781b2ad306dae8452_720w.webp)
...
![img](../笔记图片/v2-2286732143495286016b21bf71d25415_720w.webp)
...
![img](../笔记图片/v2-bae799c2336b2555f96193d6358c28ee_720w.webp)
...
![img](../笔记图片/v2-a5d57772ff94690f48ab9a2dc27b8ed0_720w.webp)
...
![img](../笔记图片/v2-9749db9c247d9bf5ce1afd0c1deec5d5_720w.webp)
...
![img](../笔记图片/v2-c8c1950272b46a499d196e02333b7339_720w.webp)

有防腐层的情况：

![img](../笔记图片/v2-251ec60197da62a65d1613a4d20767be_720w.webp)
...
![img](../笔记图片/v2-79de25873eae7f90c0e2b8c1ff610ec1_720w.webp)
...
![img](../笔记图片/v2-3569e9f56a3baaf031f6ad582a72d79b_720w.webp)

## **案例** 

用一个常见的例子：下单后支付并发货如果这个案例是Orchestration，则业务逻辑为：下单时从一个预存的账户里扣取资金，并且生成物流单发货，从图上看是这样的：

![img](../笔记图片/v2-98204f5270b52eddfb1f77161205a612_720w.webp)

如果这个案例是Choreography，则业务逻辑为：下单，然后等支付成功事件，然后再发货，类似这样：

![img](../笔记图片/v2-802ef5d3893f21c1f572b5e7aee4b616_720w.webp)
...
![img](../笔记图片/v2-80cb9847e4617a386e4614c5d0799e95_720w.webp)
...
![img](../笔记图片/v2-1711eb67ce5bab3c83f8f20738fc3d83_720w.webp)

在代码中的依赖是比较明确的：如果你是下游，上游对你无感知，则只能走事件驱动；如果上游必须要对你有感知，则可以走指令驱动。反过来，如果你是上游，需要对下游强依赖，则是指令驱动；如果下游是谁无所谓，则可以走事件驱动。

\2. 找出业务中的“负责人”：

![img](../笔记图片/v2-0e97571723f1ba687df03d4b61f63446_720w.webp)
