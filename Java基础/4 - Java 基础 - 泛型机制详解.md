...
![img](./../笔记图片/java-basic-generic-4.png)

- 调用泛型方法语法格式

![img](./../笔记图片/java-basic-generic-5.png)
...
![img](./../笔记图片/java-basic-generic-1.png)
...
![img](./../笔记图片/java-basic-generic-2.png)

- 擦除方法定义中的类型参数

擦除方法定义中的类型参数原则和擦除类定义中的类型参数是一样的，这里仅以擦除方法定义中的有限制类型参数为例。

![img](./../笔记图片/java-basic-generic-3.png)
